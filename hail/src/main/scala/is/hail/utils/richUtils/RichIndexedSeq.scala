...
/** Rich wrapper for an indexed sequence.
  ...
  * 2.)
  */
final class RichIndexedSeq[A](override val a: IndexedSeq[A])
  extends RichIndexable[A, IndexedSeq] {
  override def T: RichIndexableOps[IndexedSeq] =
    RichIndexedSeq
}

case object RichIndexedSeq extends RichIndexableOps[IndexedSeq] {
  ...
  override def assign[A](r: IndexedSeq[A], i: Int, a: A): Unit = r.updated(i, a)
}
