...
package object services {
  ...
  @tailrec private def isLimitedRetriesError(_e: Throwable): Boolean = {
    ...
    e match {
      case e: RuntimeException if e.getMessage != null && e.getMessage == Constants.STREAM_CLOSED =>
        true
      ...
      case e: IOException
        ...
        true
      case e: SSLException if e.getMessage != null && e.getMessage.contains("Tag mismatch!") =>
  ...
  def isTransientError(_e: Throwable): Boolean = {
    ...
    e match {
      ...
      case e: HttpResponseException
        ...
        // }
        true
      case e: ClientResponseException if RETRYABLE_HTTP_STATUS_CODES.contains(e.status) =>
        true
      ...
      case _: HttpHostConnectException |
        ...
        true
      case e: SocketException
          if e.getMessage != null && (e.getMessage.contains("Connection timed out (Read failed)") ||
      ...
      case e: EOFException
        ...
        true
      case e: IllegalStateException if e.getMessage.contains("Timeout on blocking read") =>
