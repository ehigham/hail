...
final case class SCanonicalLocusPointer(pType: PCanonicalLocus) extends SLocus {
  ...
  override def copiedType: SType = SCanonicalLocusPointer(
    pType.copiedType.asInstanceOf[PCanonicalLocus]
  )
...
class SCanonicalLocusPointerValue(
  ...
  override def structRepr(cb: EmitCodeBuilder): SBaseStructValue =
    new SBaseStructPointerValue(SBaseStructPointer(st.pType.representation), a)
}
...
final class SCanonicalLocusPointerSettable(
  ...
  override def structRepr(cb: EmitCodeBuilder): SBaseStructPointerSettable =
    new SBaseStructPointerSettable(SBaseStructPointer(st.pType.representation), a)
}
