...
class StagedArrayBuilder(
  ...
  val ref: Value[Any] = coerce[Any](ti match {
    case BooleanInfo =>
      mb.genLazyFieldThisRef[BooleanMissingArrayBuilder](
        Code.newInstance[BooleanMissingArrayBuilder, Int](len),
        "zab",
      )
    case IntInfo =>
      mb.genLazyFieldThisRef[IntMissingArrayBuilder](
        Code.newInstance[IntMissingArrayBuilder, Int](len),
        "iab",
      )
    case LongInfo =>
      mb.genLazyFieldThisRef[LongMissingArrayBuilder](
        Code.newInstance[LongMissingArrayBuilder, Int](len),
        "jab",
      )
    case FloatInfo =>
      mb.genLazyFieldThisRef[FloatMissingArrayBuilder](
        Code.newInstance[FloatMissingArrayBuilder, Int](len),
        "fab",
      )
    case DoubleInfo =>
      mb.genLazyFieldThisRef[DoubleMissingArrayBuilder](
  ...
  def update(cb: EmitCodeBuilder, i: Code[Int], x: Code[_]): Unit = cb.append(ti match {
    case BooleanInfo =>
      coerce[BooleanMissingArrayBuilder](ref)
        .invoke[Int, Boolean, Unit]("update", i, coerce[Boolean](x))
    case IntInfo =>
    ...
    case DoubleInfo =>
      coerce[DoubleMissingArrayBuilder](ref)
        .invoke[Int, Double, Unit]("update", i, coerce[Double](x))
  })
