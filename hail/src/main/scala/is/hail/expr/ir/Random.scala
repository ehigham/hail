...
object Threefry {
  ...
  val defaultKey: IndexedSeq[Long] =
    expandKey(
      FastSeq(0x215d6dfdb7dfdf6bL, 0x045cfa043329c49fL, 0x9ec75a93692444ddL, 0x1284681663220f1cL)
    )
...
object ThreefryRandomEngine {
  def apply(): ThreefryRandomEngine = {
    ...
    new ThreefryRandomEngine(key(0), key(1), key(2), key(3), key(4), 0, 0, 0, 0, 0, 0)
  }
