      ...
      .consume(
        ...
        { case pc: SStringValue =>
          ...
          setRepr(
            ...
            true,
            getAllDefined,
            getSupportsBool && Code
              .invokeScalaObject1[String, Boolean](ImputeTypeState.getClass, "matchBoolean", s),
            getSupportsI32 && Code
              .invokeScalaObject1[String, Boolean](ImputeTypeState.getClass, "matchInt32", s),
            getSupportsI64 && Code
              .invokeScalaObject1[String, Boolean](ImputeTypeState.getClass, "matchInt64", s),
            getSupportsF64 && Code
              .invokeScalaObject1[String, Boolean](ImputeTypeState.getClass, "matchFloat64", s),
          )
        },
      )
  }
