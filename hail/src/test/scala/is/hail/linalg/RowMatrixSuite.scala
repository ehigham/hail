...
class RowMatrixSuite extends HailSuite {
  ...
  def localizeRowMatrix() {
    ...
    val rowArrays = Array(Array(1.0, 2.0, 3.0), Array(4.0, 5.0, 6.0))
  ...
  def readBlockSmall() {
    ...
    val localMatrix = DenseMatrix(Array(1.0, 2.0, 3.0), Array(4.0, 5.0, 6.0))
  ...
  def readBlock() {
    ...
    for {
      ...
      BlockMatrix
        .fromBreezeMatrix(lm, blockSize).write(ctx, fname, overwrite = true, forceRowMajor = true)
  ...
  @Test
  def exportWithIndex() {
    val rowArrays = Array(Array(1.0, 2.0, 3.0), Array(4.0, 5.0, 6.0), Array(7.0, 8.0, 9.0))
    val rowMatrix = rowArrayToRowMatrix(rowArrays, nPartitions = 2)

    val rowArraysWithIndex =
      Array(Array(0.0, 1.0, 2.0, 3.0), Array(1.0, 4.0, 5.0, 6.0), Array(2.0, 7.0, 8.0, 9.0))

    exportImportAssert(
      rowMatrix
        .export(ctx, _, ",", header = None, addIndex = true, exportType = ExportType.CONCATENATED),
  ...
  def exportSquare() {
    ...
    exportImportAssert(
      rowMatrix
        .export(ctx, _, ",", header = None, addIndex = false, exportType = ExportType.CONCATENATED),
      rowArrays: _*
    )
  ...
  @Test
  def exportTall() {
    val rowArrays = Array(Array(1.0, 2.0), Array(4.0, 5.0), Array(7.0, 8.0))
    val rowMatrix = rowArrayToRowMatrix(rowArrays)
