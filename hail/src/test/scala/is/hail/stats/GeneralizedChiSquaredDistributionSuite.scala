...
class GeneralizedChiSquaredDistributionSuite extends HailSuite {
  ...
  @Test def test0(): Unit = {
    ...
    assert(
      nearEqualDAT(actualTrace, DaviesAlgorithmTrace(0.76235, 744, 2, 0.03819, 53.37969, 0.0, 51))
    )
  ...
  @Test def test3(): Unit = {
    ...
    assert(
      nearEqualDAT(actualTrace, DaviesAlgorithmTrace(0.84764, 74, 1, 0.03514, 2.55311, 0.0, 22))
    )
    assert(actualFault == 0)
  }
  ...
  @Test def test4(): Unit = {
    ...
    assert(
      nearEqualDAT(actualTrace, DaviesAlgorithmTrace(1.74138, 66, 1, 0.03907, 2.55311, 0.0, 22))
    )
    assert(actualFault == 0)
  }
  ...
  @Test def test6(): Unit = {
    ...
    assert(
      nearEqualDAT(actualTrace, DaviesAlgorithmTrace(1.20122, 18, 1, 0.02706, 0.46096, 0.0, 20))
    )
    assert(actualFault == 0)
  }
  ...
  @Test def test7(): Unit = {
    ...
    assert(
      nearEqualDAT(actualTrace, DaviesAlgorithmTrace(2.06868, 15, 1, 0.03269, 0.46096, 0.0, 20))
    )
    assert(actualFault == 0)
  }
  ...
  @Test def test8(): Unit = {
    ...
    assert(
      nearEqualDAT(actualTrace, DaviesAlgorithmTrace(3.58496, 10, 1, 0.05141, 0.46096, 0.0, 20))
    )
    assert(actualFault == 0)
  }
  ...
  @Test def test9(): Unit = {
    ...
    assert(
      nearEqualDAT(actualTrace, DaviesAlgorithmTrace(1.29976, 27, 1, 0.03459, 0.88302, 0.0, 19))
    )
    assert(actualFault == 0)
  }
  ...
  @Test def test10(): Unit = {
    ...
    assert(
      nearEqualDAT(actualTrace, DaviesAlgorithmTrace(2.01747, 24, 1, 0.03887, 0.88302, 0.0, 19))
    )
    assert(actualFault == 0)
  }
  ...
  @Test def test11(): Unit = {
    ...
    assert(
      nearEqualDAT(actualTrace, DaviesAlgorithmTrace(3.81157, 17, 1, 0.05628, 0.88302, 0.0, 19))
    )
    assert(actualFault == 0)
  }
  ...
  @Test def test12(): Unit = {
    ...
    assert(
      nearEqualDAT(actualTrace, DaviesAlgorithmTrace(1.16271, 16, 1, 0.01561, 0.24013, 0.0, 19))
    )
    assert(actualFault == 0)
  }
  ...
  @Test def test13(): Unit = {
    ...
    assert(
      nearEqualDAT(actualTrace, DaviesAlgorithmTrace(2.02277, 13, 1, 0.01949, 0.24013, 0.0, 19))
    )
    assert(actualFault == 0)
  }
  ...
  @Test def test14(): Unit = {
    ...
    assert(
      nearEqualDAT(actualTrace, DaviesAlgorithmTrace(3.09687, 10, 1, 0.02825, 0.24013, 0.0, 19))
    )
    assert(actualFault == 0)
  }
  ...
  @Test def test15(): Unit = {
    ...
    assert(
      nearEqualDAT(actualTrace, DaviesAlgorithmTrace(0.8712, 603, 2, 0.01628, 13.86318, 0.0, 49))
    )
    assert(actualFault == 0)
  }
  ...
  @Test def test17(): Unit = {
    ...
    assert(
      nearEqualDAT(actualTrace, DaviesAlgorithmTrace(3.06625, 87, 1, 0.02888, 2.47557, 0.81533, 29))
    )
    assert(actualFault == 0)
  }
  ...
  @Test def test21(): Unit = {
    ...
    assert(
      nearEqualDAT(actualTrace, DaviesAlgorithmTrace(1.65876, 10, 1, 0.01346, 0.12785, 0.0, 18))
    )
    assert(actualFault == 0)
  }
  ...
  @Test def test22(): Unit = {
    ...
    assert(
      nearEqualDAT(actualTrace, DaviesAlgorithmTrace(2.34799, 9, 1, 0.01668, 0.12785, 0.0, 18))
    )
    assert(actualFault == 0)
  }
  ...
  @Test def test23(): Unit = {
    ...
    assert(
      nearEqualDAT(actualTrace, DaviesAlgorithmTrace(3.11236, 7, 1, 0.02271, 0.12785, 0.0, 18))
    )
    assert(actualFault == 0)
  }
  ...
  @Test def test24(): Unit = {
    ...
    assert(
      nearEqualDAT(actualTrace, DaviesAlgorithmTrace(1.42913, 10, 1, 0.01483, 0.12785, 0.0, 19))
    )
    assert(actualFault == 0)
  }
  ...
  @Test def test25(): Unit = {
    ...
    assert(
      nearEqualDAT(actualTrace, DaviesAlgorithmTrace(1.42909, 8, 1, 0.01771, 0.12785, 0.0, 19))
    )
    assert(actualFault == 0)
  }
  ...
  @Test def test26(): Unit = {
    ...
    assert(
      nearEqualDAT(actualTrace, DaviesAlgorithmTrace(2.19476, 10, 1, 0.01381, 0.12785, 0.0, 19))
    )
    assert(actualFault == 0)
  }
  ...
  @Test def test27(): Unit = {
    ...
    assert(
      nearEqualDAT(actualTrace, DaviesAlgorithmTrace(2.33438, 9, 1, 0.01202, 0.09616, 0.0, 18))
    )
    assert(actualFault == 0)
  }
  ...
  @Test def test30(): Unit = {
    ...
    assert(
      nearEqualDAT(actualTrace, DaviesAlgorithmTrace(0.95892, 163, 1, 0.00841, 1.3638, 0.0, 22))
    )
    assert(actualFault == 0)
  }
  ...
  @Test def test31(): Unit = {
    ...
    assert(
      nearEqualDAT(actualTrace, DaviesAlgorithmTrace(1.72922, 159, 1, 0.00864, 1.3638, 0.0, 22))
    )
    assert(actualFault == 0)
  }
  ...
  @Test def test32(): Unit = {
    ...
    assert(
      nearEqualDAT(actualTrace, DaviesAlgorithmTrace(4.61788, 143, 1, 0.00963, 1.3638, 0.0, 22))
    )
    assert(actualFault == 0)
  }
  ...
  @Test def test33(): Unit = {
    ...
    assert(
      nearEqualDAT(actualTrace, DaviesAlgorithmTrace(1.26245, 97, 1, 0.00839, 0.80736, 0.0, 21))
    )
    assert(actualFault == 0)
  }
  ...
  @Test def test34(): Unit = {
    ...
    assert(
      nearEqualDAT(actualTrace, DaviesAlgorithmTrace(2.16513, 93, 1, 0.00874, 0.80736, 0.0, 21))
    )
    assert(actualFault == 0)
  }
  ...
  @Test def test35(): Unit = {
    ...
    assert(
      nearEqualDAT(actualTrace, DaviesAlgorithmTrace(3.97055, 86, 1, 0.00954, 0.80736, 0.0, 21))
    )
    assert(actualFault == 0)
  }
  ...
  @Test def test36(): Unit = {
    ...
    assert(
      nearEqualDAT(actualTrace, DaviesAlgorithmTrace(1.65684, 81, 1, 0.00843, 0.67453, 0.0, 20))
    )
    assert(actualFault == 0)
  }
  ...
  @Test def test37(): Unit = {
    ...
    assert(
      nearEqualDAT(actualTrace, DaviesAlgorithmTrace(2.44382, 78, 1, 0.00878, 0.67453, 0.0, 20))
    )
    assert(actualFault == 0)
  }
  ...
  @Test def test38(): Unit = {
    ...
    assert(
      nearEqualDAT(actualTrace, DaviesAlgorithmTrace(3.75545, 72, 1, 0.00944, 0.67453, 0.0, 20))
    )
    assert(actualFault == 0)
  }
}
