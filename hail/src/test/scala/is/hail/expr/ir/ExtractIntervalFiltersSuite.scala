...
class ExtractIntervalFiltersSuite extends HailSuite { outer =>
  ...
  @Test def testIsNA(): Unit = {
    val testRows = FastSeq(Row(0, 0, true), Row(0, null, true))
    checkAll(
      IsNA(k1),
      ref1,
      k1Full,
  ...
  @Test def testKeyComparison() {
    def check(
      ...
      val testRows = FastSeq(Row(0, -1, true), Row(0, 0, true), Row(0, 1, true), Row(0, null, true))
    ...
    check(
      ...
      FastSeq(Interval(Row(), Row(0), true, false), Interval(Row(0), Row(null), false, false)),
      FastSeq(Interval(Row(null), Row(), true, true)),
    )
    ...
    check(
      ...
      I32(0),
      FastSeq(Interval(Row(0), Row(0), true, true)),
      FastSeq(Interval(Row(), Row(0), true, false), Interval(Row(0), Row(), false, true)),
      FastSeq(),
    )
    check(
      EQWithNA(TInt32),
  ...
  @Test def testLiteralContains() {
    def check(
      ...
      val testRows = FastSeq(Row(0, 1, true), Row(0, 5, true), Row(0, 10, true), Row(0, null, true))
    ...
    for {
      ...
      check(
        invoke("contains", TBoolean, lit, k1),
        FastSeq(Interval(Row(1), Row(1), true, true), Interval(Row(10), Row(10), true, true)),
        FastSeq(
          Interval(Row(), Row(1), true, false),
          Interval(Row(1), Row(10), false, false),
  ...
  @Test def testIntervalContains() {
    ...
    checkAll(
      ...
      FastSeq(Interval(Row(), Row(1), true, true), Interval(Row(5), Row(null), false, false)),
      FastSeq(Interval(Row(null), Row(), true, true)),
    )
  }
  ...
  @Test def testIntervalContainsStruct() {
    ...
    for (k <- fullKeyRefs) {
      check(
        ...
        FastSeq(Interval(Row(), Row(1, 1), true, true), Interval(Row(2, 2), Row(), false, true)),
        FastSeq(),
      )
    }
    ...
    for (k <- prefixKeyRefs) {
      check(
        ...
        FastSeq(Interval(Row(), Row(1), true, true), Interval(Row(2), Row(), false, true)),
        FastSeq(),
      )
    }
  }
  ...
  @Test def testLocusPositionComparison() {
    ...
    check(
      ...
      FastSeq(Interval(Row(), Row(100), true, false), Interval(Row(100), Row(null), false, false)),
      FastSeq(Interval(Row(null), Row(), true, true)),
    )
    check(
      EQ(TInt32),
    ...
    check(
      ...
      100,
      FastSeq(Interval(Row(100), Row(100), true, true)),
      FastSeq(Interval(Row(), Row(100), true, false), Interval(Row(100), Row(), false, true)),
      FastSeq(),
    )
    check(
      EQWithNA(TInt32),
  ...
  @Test def testLocusContigContains() {
    ...
    def check(
      ...
      val testRows =
        FastSeq(Row(Locus("chr1", 5)), Row(Locus("chr2", 1)), Row(Locus("chr10", 5)), Row(null))
    ...
    for {
      ...
      check(
        ...
        FastSeq(
          Interval(Row(), Row(Locus("chr1", 1)), true, false),
          Interval(
            Row(Locus("chr1", grch38.contigLength("chr1"))),
            Row(Locus("chr10", 1)),
            true,
          ...
          Interval(Row(Locus("chr10", grch38.contigLength("chr10"))), Row(null), true, false),
        ),
        FastSeq(),
      )
    }
    ...
    for {
      ...
      check(
        ...
        FastSeq(
          ...
          Interval(Row(Locus("chr10", grch38.contigLength("chr10"))), Row(), true, true),
        ),
        FastSeq(),
      )
    }
  ...
  @Test def testIntervalListFold() {
    ...
    check(
      ...
      FastSeq(Interval(Row(-10), Row(10), true, false), Interval(Row(20), Row(25), true, false)),
      FastSeq(
  ...
  @Test def testDisjunction() {
    ...
    check(
      or(lt5, gt10),
      FastSeq(Interval(Row(), Row(5), true, false), Interval(Row(10), Row(null), false, false)),
    ...
    check(
      ...
      trueResidual = and(not(or(False(), unknownBool)), not(or(False(), unknownBool))),
      naResidual = IsNA(and(not(or(lt5, unknownBool)), not(or(gt10, unknownBool)))),
    )
  }
  ...
  @Test def testConjunction() {
    ...
    check(
      ...
      FastSeq(Interval(Row(), Row(5), true, true), Interval(Row(10), Row(null), true, false)),
      FastSeq(Interval(Row(null), Row(), true, true)),
    )
  ...
  @Test def testCoalesce(): Unit = {
    ...
    check(
      ...
      FastSeq(Interval(Row(5), Row(null), false, false)),
      FastSeq(Interval(Row(), Row(5), true, true), Interval(Row(null), Row(), true, true)),
      FastSeq(),
    )
  }
  ...
  @Test def testRelationalChildren(): Unit = {
    val testRows = FastSeq(Row(0, 0, true), Row(0, 10, true), Row(0, 20, true), Row(0, null, true))
  ...
  @Test def testIntegration() {
    ...
    assert(
      ExtractIntervalFilters(ctx, tf)
        .asInstanceOf[TableFilter].child.isInstanceOf[TableFilterIntervals]
    )
